...
public class MiniGoParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, IDENTIFIER=3, WS=4;
	public static final int
		RULE_root = 0;
	...
	public static class RootContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MiniGoListener ) ((MiniGoListener)listener).enterRoot(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MiniGoListener ) ((MiniGoListener)listener).exitRoot(this);
		}
	}
